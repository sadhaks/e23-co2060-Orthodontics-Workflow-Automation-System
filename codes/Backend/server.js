...
const paymentRecordRoutes = require('./src/routes/paymentRecords');
const patientMaterialRoutes = require('./src/routes/patientMaterials');
...
app.use('/api/patient-materials', patientMaterialRoutes);
...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      paymentRecords: '/api/payment-records',
      patientMaterials: '/api/patient-materials',
      queue: '/api/queue',
      cases: '/api/cases',
